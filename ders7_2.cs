...
{
    public partial class ders7_2 : Form
    {
        public ders7_2()
        {
            InitializeComponent();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            bağlan.Open();
            SqlCommand komut = new SqlCommand("Select * from soru5" +
        ...
        {
            Ders7_3 c = new Ders7_3();
            c.Show();
            
        }

        private void ders7_2_Load(object sender, EventArgs e)
        {
